...
public class ControleBtRemoveLista implements ActionListener {
	...
	public ControleBtRemoveLista(JTable tableLista, ModelTable modelTableLista, ModelTable modelTabPilha,
	...
	private void tbRemoveLista() {
		...
		ControllerTable ct = new ControllerTable(modelTableLista, modelTabPilha, modelTableFila, tableLista, tablePilha, tableFila, lista, pilha, fila);
